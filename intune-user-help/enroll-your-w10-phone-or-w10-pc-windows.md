---
title: Intune 관리에서 Windows 10 디바이스 등록 | Microsoft Docs
description: Intune에서 관리되는 Windows 10 모바일 또는 데스크톱 디바이스를 가져오는 방법에 대해 설명합니다.
keywords: ''
author: lenewsad
ms.author: lanewsad
manager: dougeby
...
ms.locfileid: "55836305"
---
# <a name="enroll-your-windows-10-devices-in-intune"></a>Intune에서 Windows 10 디바이스 등록
...
자세히 알고 싶으세요? [Intune에서 디바이스를 등록](what-happens-if-you-install-the-company-portal-app-and-enroll-your-device-in-intune-windows.md)하면 어떻게 되는지 그리고 그것이 [디바이스의 정보](what-info-can-your-company-see-when-you-enroll-your-device-in-intune.md)에 어떤 영향을 주는지 알아보세요.
...
3.  __디바이스 정보__ 아래에서 __자세히__를 누릅니다. 디바이스에 대한 정보 목록이 표시됩니다. 이 목록에서 __버전__을 찾습니다.        
4.  버전이 __1607 이상인 경우__ [이 단계를 따릅니다](enroll-your-w10-device-access-work-or-school.md). 버전이 __1511 이하__인 경우 [이 단계](enroll-your-w10-device-your-account.md)를 계속 진행합니다.
