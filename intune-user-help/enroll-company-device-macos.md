...
5. Wi-Fi에 연결되면 **원격 관리** 화면이 나타납니다. 원격 관리를 통해 조직의 관리자는 회사에서 필요로 하는 계정, 설정, 앱 및 네트워크를 사용하여 장치를 원격으로 구성할 수 있습니다. 장치가 관리되는 방식을 이해하는 데 유용한 원격 관리 설명을 읽어보세요. **계속**을 클릭합니다.  
...
장치에서 macOS용 Intune 회사 포털 앱을 다운로드합니다. 이 앱을 사용하면 관리에서 장치를 모니터링, 동기화, 추가 및 제거하고 앱을 설치할 수 있습니다. 또한 이러한 단계는 회사 포털을 사용하여 장치를 등록하는 방법을 설명합니다.  
1. macOS 장치에서 http://portal.manage.microsoft.com/EnrollmentRedirect.aspx로 이동합니다.
...
5. 장치를 찾아 **등록**을 클릭합니다.
6. **계속** > **완료**를 클릭합니다. 이제 장치가 회사 및 규격 장치로 회사 포털 앱에 나타납니다.
