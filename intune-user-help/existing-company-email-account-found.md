...
조직이나 회사에서 사용하는 메일 계정이 이미 있으며 모바일 디바이스에서 해당 계정에 액세스하려고 할 경우가 있습니다. 메일을 사용자 디바이스로 전송한 사람의 작업에서 메일 액세스에 대한 보안 유지를 위해 회사 지원팀에 도움이 필요합니다. 현재 메일은 작업에 사용되지만 다음 단계를 통해 정보를 안전하게 유지합니다.

1.  디바이스에 대한 **설정**을 확인하고 사용자의 회사 메일에 이전에 설정한 연결을 제거 합니다.  예를 들어 iOS 디바이스에서 **설정** > **메일** > **계정**을 탭합니다. 회사 메일 계정을 선택한 다음 **삭제**를 탭합니다.

2.  디바이스에서 **설정**을 종료하고 회사 포털 앱을 엽니다.  

3. **장치**로 이동하여 업데이트하려는 장치를 선택합니다.

4. **설정 확인**을 선택합니다. 잠시 후에 디바이스가 새 메일 설정으로 업데이트됩니다.
