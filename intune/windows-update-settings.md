...
- **사용자가 다시 시작할 수 있도록 허용(개입형 다시 시작)**  
  **기본값**: 구성되지 않음  
  > [!IMPORTANT]  
  > *개입 된 다시 시작* 설정은 더 이상 사용 하지 않는 것이 좋습니다. 대신, 새 *최종 기한* 설정을 사용 하 여 *개입 된 다시 시작* 설정을 대체 합니다. Intune은 향후 업데이트에서 [ *개입 된 다시 시작* 설정에 대 한 지원을 사용 중단](whats-new.md#plan-for-change-new-windows-updates-settings-in-intune-) 합니다.
...
- **최종 기한 설정 사용**  
  **기본값**: 구성되지 않음  
  > [!IMPORTANT]  
  > Intune에 대 한 8 월 업데이트부터, 사용 중인 다시 시작 설정을 대체 하는 다음과 같은 최종 기한 설정을 사용 하는 것이 좋습니다. Intune은 향후 Intune 업데이트에서 [ *개입 된 다시 시작* 설정을 지원 사용 중단](whats-new.md#plan-for-change-new-windows-updates-settings-in-intune-) 합니다.  
