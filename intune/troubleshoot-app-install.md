...
이 섹션에서는 장치 관리자 (DA) 및 Samsung Knox 등록에 대해 설명 합니다. 자세한 내용은 [android 장치 관리자 등록](android-enroll-device-administrator.md) 을 참조 하 고, [Samsung Knox 모바일 등록을 사용 하 여 Android 장치를 자동으로 등록](android-samsung-knox-mobile-enroll.md)을 참조 하세요. 
