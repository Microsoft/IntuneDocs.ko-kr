...
* **배포 모드**(Windows 10 Insider Preview 빌드 17672 이상)에 대해 **자체 배포(미리 보기)** 를 선택한 경우에만 **언어(지역)** 및 **키보드 자동으로 구성**을 모두 사용할 수 있습니다.
...
필수 구성 요소: Azure Active Directory 회사 포털이 구성되었습니다.
