...
- **Intune 서비스 관리자:** 이 역할의 사용자는 서비스 제공 시 Intune 내에서 전역 권한을 소유합니다. 또한 대체하는 Azure 제한 사항 외에도 이 역할은 사용자 및 디바이스를 관리하고 Intune 그룹을 만들고 관리하는 기능을 제공합니다.
...
- **응용 프로그램 관리자**: 모바일 및 관리되는 응용 프로그램을 관리하며, 장치 정보를 읽고, 장치 구성 프로필을 볼 수 있습니다.
