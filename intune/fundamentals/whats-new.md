...
#### <a name="we-have-updated-two-device-restriction-settings-for-ios-and-ipados-devices-to-correct-their-behavior---5701352-wnready-----"></a>디바이스의 동작 수정을 위해 iOS 및 iPadOS용 디바이스 제한 설정 두 가지를 업데이트했습니다<!-- 5701352 WNReady   -->
