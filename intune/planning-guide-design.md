...
사용자와 디바이스 그룹이 정책, 응용 프로그램 및 프로필 등의 배포 대상을 결정합니다. 필요한 사용자와 디바이스 그룹을 결정해야 합니다.
...
Intune을 사용하여 여러 방법으로 사용자 또는 디바이스에 앱을 제공할 수 있습니다. 응용 프로그램의 유형은 소프트웨어 설치 관리자 앱, 공용 앱 스토어의 앱, 외부 링크 또는 관리되는 iOS 앱일 수 있습니다. 개별 앱 배포 외에도 대량 구매 앱은 iOS 및 Windows의 대량 구매 프로그램을 통해 관리하고 배포할 수 있습니다. 다음에 대해 자세히 알아보세요.
...
앱을 사용자 및 디바이스에 배포할 수 있으므로 Intune에서 관리할 응용 프로그램을 결정하는 것이 좋습니다. 목록을 수집하는 동안 다음 질문에 대답해 보세요.
