...
- **관리 되는 앱이 관리 되지 않는 연락처 계정에 연락처를 쓸 수 있도록 허용**: **허용**으로 설정 하면 Outlook 모바일 앱과 같은 관리 되는 앱에서 비즈니스 및 회사 연락처를 비롯 한 연락처 정보를 기본 제공 iOS 연락처 앱에 저장 하거나 동기화 할 수 있습니다. **구성 되지 않음** (기본값)으로 설정 되 면 관리 되는 앱은 장치에 있는 기본 제공 iOS 연락처 앱에 연락처 정보를 저장 하거나 동기화 할 수 없습니다.
