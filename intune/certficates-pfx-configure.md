...
*PFX 인증서 커넥터*는 [자동 업데이트를 지원](#requirements)하는 반면, Intune Certificate Connector는 수동으로 업데이트해야 합니다.
 
### <a name="april-2-2019"></a>2019년 4월 2일
- **NDES 인증서 커넥터 - 버전 6.1904.1.0**  
  이 릴리스의 변경 내용:  
