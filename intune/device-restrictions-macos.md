...
- **암호 자동 채우기 차단**: **차단**을 선택하면 macOS에서 암호 자동 채우기 기능 사용이 제한됩니다. **차단**을 선택하면 다음과 같이 설정됩니다.
...
- **암호 근접 요청 차단**: **차단**을 선택하면 사용자의 디바이스가 가까운 디바이스의 암호를 요청하지 않습니다. **구성되지 않음**을 사용하면 이러한 암호 요청이 허용됩니다.

- **암호 공유 차단**: **차단**을 선택하면 AirDrop을 사용하여 디바이스 간에 암호를 공유할 수 없습니다. **구성되지 않음**을 사용하면 암호를 공유할 수 있습니다.
