...
- **잠긴 화면 그림 URL(데스크톱 전용)**: Windows 잠금 화면 배경으로 사용할 JPEG 형식의 사진에 URL을 입력합니다. 이 설정은 이미지를 잠급니다. 이미지는 나중에 변경할 수 없습니다.
...
- **Microsoft 호환성 목록**: **차단**을 선택하면 Microsoft Edge에서 Microsoft 호환성 목록이 사용되지 않습니다. Microsoft에서 제공하는 이 목록은 Microsoft Edge에서 알려진 호환성 문제가 있는 사이트를 표시하는 데 유용합니다. **구성되지 않음**을 사용하면 Microsoft 호환성 목록을 사용할 수 있습니다.
...
- **작업 표시줄에서 앱 고정 해제**: **차단**을 선택하여 사용자가 작업 표시줄에서 앱 고정을 해제하지 못하게 합니다.
