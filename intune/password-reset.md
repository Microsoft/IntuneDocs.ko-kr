...
직원은 지원 센터의 도움 없이도 회사 및 학교 계정 암호를 다시 설정할 수 있도록 허용할 수 있습니다. 이러한 유형의 셀프 서비스 암호 재설정은 다음과 같은 경우에 권장됩니다.
* 회사와 학교는 업무 및 학교 계정에 대해 Azure Active Directory를 사용하는 경우
