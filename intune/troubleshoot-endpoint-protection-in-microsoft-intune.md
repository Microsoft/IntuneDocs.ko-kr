...
|**다른 엔드포인트 보호 응용 프로그램이 실행되고 있음**|다른 엔드포인트 보호 응용 프로그램이 실행되고 있으며 컴퓨터가 정상 상태입니다.|기본적으로 다른 Endpoint Protection 응용 프로그램이 설치되어 있고 Intune에서 해당 응용 프로그램을 검색한 경우 디바이스가 불안정해질 수 있습니다.|
