...
- Bit 락커 이동식 드라이브 정책 > **암호화 방법**
- **비트 락커 고정 드라이브 정책** *(모든 설정)*
- **Bit 락커 시스템 드라이브 정책** *(모든 설정)*
...
- **Internet Explorer 인터넷 영역 파일 다운로드에 대 한 자동 확인** > 기본값을 **사용할 수 없습니다**. 미리 보기에서이는 사용으로 설정 되었습니다.
