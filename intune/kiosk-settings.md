...
description: Windows 10(이상) 디바이스를 단일 앱 및 다중 앱 키오스크로 구성하고, 시작 메뉴를 사용자 지정하고, 앱을 추가하고, 작업 표시줄을 표시하고 웹 브라우저 구성합니다. 또한 Windows Holographic for Business 디바이스를 Microsoft Intune에서 다중 앱 키오스크로 구성합니다.
keywords: ''
...
ms.locfileid: "54203470"
---
# <a name="windows-10-and-later-device-settings-to-run-as-a-dedicated-kiosk-using-intune"></a>Intune을 사용하여 Windows 10 이상 디바이스를 전용 키오스크로 실행하기 위한 설정
...
이 문서에서는 Windows 10 이상 디바이스에서 제어할 수 있는 다양한 메일 설정을 나열하고 설명합니다. MDM(모바일 디바이스 관리) 솔루션의 일부로, 이러한 설정을 사용하여 키오스크 모드로 실행하기 위해 Windows 10 디바이스를 구성합니다.
...
[디바이스 구성 프로필을 만듭니다](device-profile-create.md).
