...
다음 표에서는 정책에서 구성할 수 있는 값과 정책을 사용자 지정하지 않은 경우 사용되는 권장 값을 보여 줍니다. 이러한 설정은 **업데이트** 섹션에서 찾아볼 수 있습니다.
  ...
  |정책 설정|세부 정보|
    |------------------|--------------------|
    |**업데이트 및 애플리케이션 검색 주기(시간)** |Intune에서 새 업데이트 및 애플리케이션에 대해 확인하는 주기(8 - 22시간)를 지정합니다.<br /><br />권장 값: **8**시간|
    |**업데이트 및 애플리케이션 자동 설치 또는 메시지 표시** |업데이트를 자동으로 설치할지 또는 설치하기 전에 사용자에게 메시지를 표시할지 여부를 지정합니다. 또한 이러한 설정을 통해 업데이트 및 애플리케이션의 설치를 예약할 수 있습니다.<br /><br />**예약한 대로 자동으로 업데이트 및 애플리케이션 설치**는 지정된 일정에 따라 업데이트 및 애플리케이션을 설치합니다.<br /><br />종속 정책 설정인 **Windows 컴퓨터에 자동 유지 관리 사용**  은 Windows 자동 유지 관리 기간 동안 업데이트 및 애플리케이션이 설치되도록 지정합니다.<br /><br />**사용자에게 확인하고 설치**는 업데이트가 준비되면 사용자에게 업데이트를 설치하라는 메시지를 표시합니다.<br /><br />권장 값:<br /><br />**예약한 대로 자동으로 업데이트 및 애플리케이션 설치** 선택<br /><br />**예약 날짜: 매일**<br /><br />**예약 시간: 오전 3시**<br /><br />**Windows 컴퓨터에 자동 유지 관리 사용** 선택|
    ...
    |**예약된 업데이트 및 애플리케이션을 설치한 후 Windows 다시 시작 지연(분)** |예약된 업데이트 및 애플리케이션을 설치한 후 Windows의 다시 시작 대기 시간(1 - 30분)을 지정합니다.<br /><br />권장 값: **15분** |
    |**예약된 업데이트 및 애플리케이션 중 누락된 설치를 시작할 수 있도록 다음 Windows 다시 시작 지연(분)** |예약된 업데이트를 설치하지 못한 경우 Windows가 다시 시작된 후 업데이트 및 애플리케이션 설치를 시작하도록 대기하는 시간(1 - 60분)을 지정합니다.<br /><br />권장 값: **5분**|
    |**예약된 업데이트 및 애플리케이션을 설치한 후 Windows 다시 시작은 로그온한 사용자가 제어하도록 허용** |로그온한 사용자가 Windows 다시 시작을 지연할 수 있는지(**예**로 설정한 경우) 또는 Windows 자동 다시 시작 메시지를 받을지(**아니요**로 설정한 경우) 여부를 지정합니다. 예약된 업데이트 및 애플리케이션 설치가 완료되었을 때 로그온한 사용자가 없는 경우 Windows를 다시 시작해야 하면 Windows가 자동으로 다시 시작됩니다. **아니요**로 설정한 경우 기본적으로 Windows가 다시 시작될 때까지 경과 시간은 5분으로 설정됩니다.<br /><br />권장 값: **예**|
    ...
    |**예약된 업데이트 및 애플리케이션을 설치한 후 Windows를 다시 시작할지 여부를 묻는 메시지 표시 지연 간격(분)** |Windows를 다시 시작해야 하는 예약된 업데이트 또는 애플리케이션을 설치한 후 사용자가 다시 시작을 지연한 경우 사용자에게 Windows를 다시 시작하라는 메시지를 표시하는 주기(1 - 1,440분)를 지정합니다.<br /><br />권장 값: **30분** |
