...
##### <a name="increase-thedevice-enrollment-limit"></a>디바이스 등록 제한 증가
...
##### <a name="checkdevice-type-restrictions"></a>디바이스 유형 제한 확인
...
2.  **장치 등록** > **등록 제한**으로 이동한 다음 **장치 유형 제한**에서 **기본** 제한을 선택 합니다.    
...
2. **Azure Active Directory** > ** 장치장치설정** > **으로 이동 합니다**  .    
...
- 컴퓨터에 Configuration Manager 클라이언트 에이전트가 설치 되어 있습니다.    
...
##### <a name="correct-themdm-terms-of-use-url"></a>MDM 사용 약관 URL 수정
  ...
  3.  **기본 Mdm Url 복원**을 선택 하 고 **MDM 사용 약관 url** 이로 **https://portal.manage.microsoft.com/TermsofUse.aspx** 설정 되었는지 확인 합니다.    
  4. **저장**을 선택합니다.    
...
##### <a name="disablemdm-automatic-enrollment-in-azure"></a>Azure에서 MDM 자동 등록을 사용 하지 않도록 설정 합니다.
...
오류: "계정 인증서가 유효 하지 않으며 만료 될 수 있습니다. 0x80cf4017."
...
- 이벤트 뷰어에서 다음 이벤트는 **응용 프로그램 및 서비스 Logs/Microsoft/Windows/DeviceManagement/Admin**에 기록 됩니다.   
    ...
    ```
**원인:** 다음 조건 중 하나에 해당 합니다. 
- UPN에는 확인 되지 않은 도메인 ( joe@contoso.local예: local)이 포함 되어 있습니다.    
...
6. **이름 확인** 을 선택 하 여 항목의 유효성을 검사 > **확인** > **다음**을 클릭 합니다.
