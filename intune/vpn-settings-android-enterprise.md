...
Intune 관리자는 Android Enterprise 장치에 대 한 VPN 설정을 만들고 할당할 수 있습니다. 

Intune의 VPN 프로필에 대 한 자세한 내용은 [vpn 프로필](vpn-settings-configure.md)을 참조 하세요.

## <a name="before-you-begin"></a>시작하기 전에

[장치 구성 프로필을 만들고](vpn-settings-configure.md#create-a-device-profile) **Android Enterprise**를 선택 합니다.
