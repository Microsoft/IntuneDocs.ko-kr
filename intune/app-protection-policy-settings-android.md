...
| **장치 암호화를 사용하는 경우 앱 암호화를 사용하지 않음** | 디바이스 암호화가 등록된 디바이스에서 검색되는 경우 **예**를 선택하여 내부 앱 저장소에 앱 암호화를 사용하지 않도록 합니다. <br><br>**참고:** Intune은 Intune MDM을 사용하여 장치 등록을 검색할 수 있습니다. 관리되지 않는 애플리케이션이 데이터에 액세스할 수 없도록 외부 앱 저장소가 계속 암호화됩니다. | 예 |
