...
4. **만들기**를 선택합니다.
     ...
     ![Intune Data Warehouse 클라이언트 앱](./media/reports-proc-data-rest/reports-get_rest_data_client_overview.png)
...
8. **위임된 권한** 상자를 선택하여 **Get data warehouse information from Microsoft Intune**(Microsoft Intune에서 데이터 웨어하우스 정보 가져오기)을 추가합니다.
    ...
    ![액세스 사용 - Microsot Intune API](./media/reports-proc-data-rest/reports-get_rest_data_client_access.png)
