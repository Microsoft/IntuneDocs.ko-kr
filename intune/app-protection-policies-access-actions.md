...
>[!NOTE]
> **디바이스 모델 또는 디바이스 제조업체** 설정을 사용하려면 세미콜론으로 구분된 디바이스 모델 식별자(iOS) 또는 디바이스 제조업체(Android) 목록을 입력합니다. 여러 값의 목록에서 공백을 방지합니다. 이러한 값은 대/소문자를 구분하지 않습니다. 
