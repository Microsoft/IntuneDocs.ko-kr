...
첫 번째 단계는 appx 패키지에 코드 서명하는 것입니다. [signtool을 사용하여 앱 패키지에 서명](https://docs.microsoft.com/windows/uwp/packaging/sign-app-package-using-signtool)을 참조하세요.

## <a name="upload-your-app"></a>앱 업로드

다음으로 [LOB Windows 앱 업로드](lob-apps-windows.md)에 설명된 대로 소명된 appx 파일을 업로드합니다.
...
Windows Phone 8.1 모바일 앱을 배포하는 데 사용되는 인증서는 2019년 2월 28일에 중단되었으며 Symantec에서 더 이상 갱신될 수 없습니다. WIndows 10 모바일에 배포하는 경우 Windows 10 지침에 따라 Symantec Desktop Enterprise 코드 서명 인증서를 계속 사용할 수 있습니다.
