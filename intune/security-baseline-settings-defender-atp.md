...
이 기준은 물리적 장치에 최적화 되어 있으며, 현재 Vm (가상 머신) 또는 VDI 끝점에서 사용 하지 않는 것이 좋습니다. 특정 기준 설정은 가상화 된 환경의 원격 대화형 세션에 영향을 줄 수 있습니다. 자세한 내용은 Windows 설명서에서 [Microsoft DEFENDER ATP 보안 기준에 대 한 준수 강화](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/configure-machines-security-baseline) 를 참조 하세요.
