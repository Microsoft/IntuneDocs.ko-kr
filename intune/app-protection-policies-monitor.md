...
-   **정책으로 관리됨**: 업무 환경에서 할당된 정책이 있는 앱을 사용한 사용자 수입니다.
...
- **플래그가 지정된 사용자**: 문제가 발생하는 사용자 수입니다. 현재 탈옥된 디바이스를 가진 사용자만이 **플래그가 지정된 사용자**로 표시됩니다.
...
-   **앱 보호 앱 보고서:** 보고서를 생성하기 전에 관리자가 선택할 수 있는 두 개의 서로 다른 앱 보호 상태를 제공합니다. 보호되거나 보호되지 않은 상태일 수 있습니다.
