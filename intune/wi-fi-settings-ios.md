---
title: Microsoft Intune에서 iOS 장치의 Wi-Fi 설정 구성 - Azure | Microsoft Docs
titleSuffix: ''
description: iOS 장치의 WiFi 장치 구성 프로필을 만들거나 추가합니다. Microsoft Intune에서 인증서 추가, EAP 유형 선택 및 인증 방법 선택을 포함하여 다양한 설정을 확인합니다.
keywords: ''
...
ms.locfileid: "49425243"
---
# <a name="add-wi-fi-settings-for-ios-devices-in-microsoft-intune"></a>Microsoft Intune에서 iOS 장치의 Wi-Fi 설정 추가

특정 WiFi 설정을 사용하여 프로필을 만든 후 iOS 장치에 이 프로필을 배포할 수 있습니다. Microsoft Intune은 네트워크에 인증, PKS 또는 SCEP 인증서 사용 등을 포함한 많은 기능을 제공합니다.
