...
- **이 VPN에 WIP 또는 앱 연결**: 일부 앱에서 이 VPN 연결을 사용하게 하려면 이 설정을 사용하도록 설정합니다. 옵션은 다음과 같습니다.
  ...
  - **이 연결에 앱 연결**: **이러한 앱에 대한 VPN 연결을 제한**한 다음, **연결된 앱**을 추가할 수 있습니다. 입력한 앱에서 자동으로 VPN 연결을 사용합니다. 앱의 유형에 따라 앱 식별자가 결정됩니다. 유니버설 앱의 경우 패키지 패밀리 이름을 입력합니다. 데스크톱 앱의 경우에는 앱의 파일 경로를 입력합니다.
  >[!IMPORTANT]
