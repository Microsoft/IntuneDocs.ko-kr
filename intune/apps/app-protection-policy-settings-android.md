...
| **승인된 키보드**  | *필요*를 선택하고 이 정책에 대해 승인된 키보드 목록을 지정합니다. <p>승인된 키보드를 사용하지 않는 사용자는 보호되는 앱을 사용하기 전에 승인된 키보드를 다운로드하여 설치하라는 메시지를 받습니다.  | **필요 없음** |
...
| <ul><ui><ul><ui> **일 수** | PIN 재설정을 요구하기 전 경과 일수를 구성합니다. <br><br> 기본값 = **90**  |
