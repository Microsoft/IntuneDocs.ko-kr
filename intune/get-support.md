...
IT 관리자 권한으로 **도움말 및 지원** 옵션을 사용하여 Azure Portal에서 Intune에 대한 온라인 지원 티켓을 저장할 수 있습니다. 지원 티켓을 만들려면 계정이 다음 [Azure Active Directory에서 관리자 역할](https://docs.microsoft.com/azure/active-directory/active-directory-assign-admin-roles-azure-portal) 중 하나로 할당되어야 합니다.
...
이 새로운 환경은 [Microsoft 365 관리 센터](https://portal.office.com/AdminPortal/Home)에 표시되는 환경과 비슷하고, [이전 도움말 및 지원 환경](#azure-help-+-support-experience)을 대체합니다. 

도움말 및 지원에 액세스하려면 다음을 사용합니다.  
- **디바이스 관리 대시보드:**
   - **도움말 및 지원**에 대한 모든 사용 가능한 옵션 선택
   - 포털의 오른쪽 위 구석에 있는 아이콘 **?** 선택

- **Azure Portal에서:**
   - Intune 블레이드 또는 페이지에서 **도움말 및 지원** 선택

   오른쪽 위 구석에서 아이콘 **?** 을 선택하거나 왼쪽 탐색 창에서 **도움말 + 지원**을 선택하면 Azure Portal의 임의 위치에서 Azure에 대한 *도움말 + 지원*이 열립니다. 최상의 환경을 위해서는 Intune 블레이드에서 *도움말 및 지원*을 사용합니다.  

새 환경을 사용하면 디바이스 관리 대시보드의 다음 이미지에 표시된 것 같이 **도움이 필요하세요?** 보기에 액세스할 수 있습니다.  
![디바이스 관리 대시보드 및 도움이 필요하십니까? 페이지](./media/get-support/help-support-dashboard.png)
...
새로운 환경에서 지원되는 위치에서 도움말 및 지원을 여는 경우 **도움이 필요하세요?**  페이지가 열립니다. 이 페이지에서는 문제에 대한 정보를 지정할 수 있습니다. 세부 정보를 입력하면 콘솔에서는 사용할 키워드를 기반으로 하는 일반적인 쿼리를 제공합니다. 제안된 선택 항목을 선택하거나 고유한 문제 설명을 완료할 수 있습니다. 고유한 설명을 입력하려면 **도움말 보기**를 선택하여 제출합니다. 쿼리를 제출한 후에 콘솔에서는 문제를 해결하는 데 도움이 될 수 있는 상황에 맞는 정보를 반환합니다.
...
다음 정보에서는 왼쪽 탐색 창 **도움말 + 지원**을 사용하거나 Azure Portal의 오른쪽 위 구석에 있는 **?** 옵션을 사용하는 경우 Azure Portal에서 액세스할 수 있는 Azure 도움말 + 지원 환경에 대해 설명합니다. Intune 블레이드에 나와 있는 대로 2019년 1월부터 *도움말 + 지원*에서 Azure *도움말 및 지원* 환경에 액세스할 수 없습니다.  
