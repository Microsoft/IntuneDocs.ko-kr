...
Intune 관리자 권한으로 **도움말 및 지원** 옵션을 사용하여 Azure Portal에서 Intune에 대한 온라인 지원 티켓을 저장할 수 있습니다. 지원 인시던트를 만들고 관리하려면 **microsoft.office365.supportTickets/allEntities/allTasks** ‘작업’을 포함하는 Azure AD(Azure Active Directory) 역할을 계정에 할당해야 합니다. 지원 티켓을 만드는 데 필요한 Azure AD 역할 및 권한에 대한 자세한 내용은 [Azure Active Directory의 관리자 역할](https://docs.microsoft.com/azure/active-directory/active-directory-assign-admin-roles-azure-portal)을 참조하세요. 
...
이 새로운 환경은 [Microsoft 365 관리 센터](https://admin.microsoft.com/)에 표시되는 환경과 비슷하고, 이전 도움말 및 지원 환경을 대체합니다. 
...
다음 정보에서는 왼쪽 탐색 창 **도움말 + 지원**을 사용하거나 Azure Portal의 오른쪽 위 구석에 있는 **?** 옵션을 사용하는 경우 Azure Portal에서 액세스할 수 있는 Azure 도움말 + 지원 환경에 대해 설명합니다. Intune 블레이드에 나와 있는 대로 2019년 1월부터 ‘도움말 및 지원’에서 Azure ‘도움말 + 지원’ 환경에 액세스할 수 없습니다.  
