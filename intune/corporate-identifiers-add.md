...
2. **식별자 추가** 블레이드에서 식별자 형식 **IMEI** 또는 **일련 번호**을 지정합니다.
...
가져온 장치가 모두 등록됨 상태로 되지는 않을 수 있습니다. 장치는 **등록됨** 또는 **연결되지 않음** 중 하나의 상태일 수 있습니다. **연결되지 않음**은 장치가 Intune 서비스와 통신된 적이 없음을 의미합니다.
