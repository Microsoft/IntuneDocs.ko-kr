...
이 기본 제공 정책을 사용하여 이 설정을 모니터링할 수 있습니다. 또한 Intune에서는 디바이스 플랫폼에 따라 다른 간격으로 [업데이트를 새로 고치거나 확인](create-compliance-policy.md#refresh-cycle-times)합니다. [Microsoft Intune의 디바이스 정책 및 프로필을 통한 일반적인 질문, 이슈 및 해결 방법](device-profile-troubleshoot.md)은 좋은 리소스입니다.
