...
범위 태그는 영업, HR, 모든 US-NC 직원 등과 같은 특정 그룹으로 정책을 할당 및 필터링할 수 있는 좋은 방법입니다. 설정을 추가한 후 준수 정책에 범위 태그를 추가할 수도 있습니다. [범위 태그를 사용하여 정책 필터링](../fundamentals/scope-tags.md)은 좋은 리소스입니다.
