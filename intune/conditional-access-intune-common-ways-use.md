...
아래 정보는 Intune 모바일 *디바이스* 규정 준수 기능 및 Intune 모바일 *애플리케이션* 관리(MAM) 기능 사용 방법의 이해에 도움이 됩니다. 
...
EAS 레코드가 신규 항목이어서 Intune이 인식할 수 없는 경우 Intune은 메일 액세스를 차단하는 cmdlet(“커맨드렛”으로 발음됨)을 실행합니다. 이 프로세스의 작동 방식에 대한 자세한 내용이 아래에 나와 있습니다.
...
> [!IMPORTANT]
> 디바이스를 사용하는 사용자에게 준수 프로필이 할당되어 있어야 디바이스에 대한 준수 여부가 평가될 수 있습니다. 사용자에게 규정 준수 정책이 배포되지 않은 경우 디바이스는 준수하는 것으로 간주되며 액세스 제한이 적용되지 않습니다.
