...
2. **장치** > **등록 제한**으로 이동한 다음 **장치 유형 제한**에서 **기본** 제한을 선택 합니다.    
...
1. [Microsoft Endpoint Manager 관리 센터](https://go.microsoft.com/fwlink/?linkid=2109431)에서 > **장치** > **windows** > **windows 장치**를 선택 합니다.
