...
2. **Azure Active Directory** > **장치** > **장치 설정**으로 이동 합니다.    
...
##### <a name="correct-the-mdm-terms-of-use-url"></a>MDM 사용 약관 URL 수정
  ...
  3. **기본 Mdm Url 복원**을 선택 하 고 **MDM 사용 약관 url** 이 **https://portal.manage.microsoft.com/TermsofUse.aspx** 으로 설정 되어 있는지 확인 합니다.    
  4. **저장**을 선택합니다.    
...
- 이벤트 뷰어에서 다음 이벤트는 **응용 프로그램 및 서비스 Logs/Microsoft/Windows/DeviceManagement/Admin**에 기록 됩니다.   
    ...
    ```
**원인:** 다음 조건 중 하나에 해당 합니다. 
- UPN에는 (예: joe@contoso.local)와 같은 확인 되지 않은 도메인 또는 라우팅 불가능 도메인이 포함 되어 있습니다.    
